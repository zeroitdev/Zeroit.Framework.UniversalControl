...
namespace Zeroit.Framework.UniversalControl.Editors
{
    partial class ComboColorPickerDialog
    {
        ...
        {
            this.comboColorPicker = new Zeroit.Framework.UniversalControl.Editors.ComboColorPicker();
            this.SuspendLayout();
            // 
            // comboColorPicker
            // 
            ...
            this.comboColorPicker.ColorSelected += new Zeroit.Framework.UniversalControl.Editors.BaseColorPicker.ColorSelectedEventHandler(this.comboColorPicker_ColorSelected);
            // 
