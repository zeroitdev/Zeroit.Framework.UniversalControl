...
namespace Zeroit.Framework.UniversalControl.Editors.PolyEditor
{
    ...
    public partial class PolygonEditorDialog : System.Windows.Forms.Form
    {
        ...
        private void Init(Polygon poly)
        {
            ...
            polyPen = new Pen(Color.Cyan, 2.0f);
        ...
        private void imagePanel_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (grid.Rows.Count > 0)
            {
                ...
                double X = (points.X / workingArea.Width) * (0.5 * imagePanel.Width);
                double Y = (points.Y / workingArea.Height) * (0.5 * imagePanel.Height); 
                

                cols[colX.Index] = Convert.ToInt32(X).ToString();
                cols[colY.Index] = Convert.ToInt32(Y).ToString();
                ...
                //cols[colX.Index] = Convert.ToInt32((sqrtX * 3)).ToString();
                //cols[colY.Index] = Convert.ToInt32((sqrtY * 3)).ToString();


                //cols[colX.Index] = Convert.ToInt32((sqrtX * 3) - 10).ToString();
                //cols[colY.Index] = Convert.ToInt32((sqrtY * 3) - 10).ToString();

                //cols[colX.Index] =  (points.X / 6).ToString();
                //cols[colY.Index] = (points.Y / 6).ToString();
            }
            else
            {
                cols[colX.Index] = "0.0";
        ...
        private void closeBtn_MouseLeave(object sender, EventArgs e)
        {
            ...
            closeBtn.BackColor = Color.FromArgb(24,24,24);
        }

        private void imagePanel_MouseMove(object sender, MouseEventArgs e)
        {
            
            location_Label.Location = new Point(e.Location.X, e.Location.Y);

            location_Label.Text = "X : " + e.X.ToString() + " Y : " + e.Y.ToString();
        }
        ...
        private void imagePanel_MouseLeave(object sender, EventArgs e)
        {
            ...
            location_Label.Location = new Point(536, 741);
        }
    }
