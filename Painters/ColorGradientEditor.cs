...
namespace Zeroit.Framework.UniversalControl.Editors
{
    ...
    public partial class ColorGradientEditor : UserControl
    {
        ...
        {
            Zeroit.Framework.UniversalControl.Editors.ComboColorPickerDialog d = new Zeroit.Framework.UniversalControl.Editors.ComboColorPickerDialog(colorLabel.BackColor, colorButton);
